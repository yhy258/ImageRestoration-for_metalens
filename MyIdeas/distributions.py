...
def _kl_powerspherical_uniform(p, q): # p : power spherical, q : uniform
    # Maximize Entropy of PowerSpherical Distribution
    # By "Disentangling disentanglment" paper : overlapping control
